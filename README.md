...
called `my_list` by running `touch my_list.txt`. The file extension suggests
to human.txts and operating systems that it contains text. Open the file in VS Code
